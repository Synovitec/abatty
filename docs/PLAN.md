...
| ID  | Change                                                                            | State   | Size |
| --- | --------------------------------------------------------------------------------- | ------- | ---- |
| C22 | A pre-flight scan for instruction-shaped content before an unattended night       | open    | M    |
| C23 | A published threat model for the sandbox: what it holds and what it does not      | open    | S    |
| C21 | A rule family for agent security: sandbox, permissions, hooks, the trust boundary | open    | M    |
| C12 | `doctor --controls` becomes a precondition of the first night, not a suggestion   | open    | S    |
...
| C13 | 5    | partial | 07   | C38 | 6    | open    | 09   |
| C14 | 5    | partial | 07   | C39 | 6    | open    | 09   |
